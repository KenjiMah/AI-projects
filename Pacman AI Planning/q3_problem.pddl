(define (problem pacmanP)
    ...
    (:init (pacman-at pac1 loc_x4y4) 
            ...
            (dot-at loc_x1y4) (dot-at loc_x2y1) (dot-at loc_x3y3) (dot-at loc_x4y4)
        (south loc_x2y1 loc_x1y1) (east loc_x1y2 loc_x1y1) (south loc_x2y2 loc_x1y2) (west loc_x1y1 loc_x1y2)  
           (south loc_x2y3 loc_x1y3) (west loc_x1y2 loc_x1y3) (east loc_x1y4 loc_x1y3) (south loc_x2y4 loc_x1y4) 
    ...
    (:goal (and (pacman-at pac1 loc_x1y1) (eaten loc_x1y4) (eaten loc_x2y1) (eaten loc_x3y3) (eaten loc_x4y4))
    )
)